...
public class ToDisplayAllRightClickOptionsContextClick {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> rightClickOptions=driver.findElements(By.xpath("//span[@class='quick-card-editor-buttons-item-text']"));
