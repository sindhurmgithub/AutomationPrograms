...
public class Script_005 {
	public static void main(String[] args)  {
		...
		//		 clickProductsName. getSelectProductsFromProductWindow().click();
				...
				TC_CreatingNewInvoice_001 clickStatus=new TC_CreatingNewInvoice_001(driver);
				clickStatus.getClickOnStatus().click();
				
				
				
				TC_CreatingNewInvoice_001 clickStatusCreditInvoice=new TC_CreatingNewInvoice_001(driver);
				clickStatusCreditInvoice.getClickOnCreditInvoiceFromDropDown().click(); 
