...
public class Script_002 {
	public static void main(String[] args)  {
		...
		//		 clickProductsName. getSelectProductsFromProductWindow().click();
				...
				TC_CreatingNewInvoice_001 clickStatusCreated=new TC_CreatingNewInvoice_001(driver);
				clickStatusCreated.getClickOnCreatedFromDropDown().click(); 
